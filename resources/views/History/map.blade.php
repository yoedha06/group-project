...
@section('content')
<button class="btn btn-danger" onclick="window.location.href='{{ route('history.index') }}'" style="padding:10px;margin-top:10px;"><i class="bi bi-arrow-left-circle"></i>&nbsp;Kembali ke History</button>
